<?php
  ...
  $dirBase = "C:/Users/Tom/Documents/UBC/CPSC 449 Thesis/MianResults/";
  $dir = new DirectoryIterator($dirBase);
  foreach ($dir as $fileinfo) {
      if (!$fileinfo->isDot()) {

        $csv = array_map('str_getcsv', file($dirBase . $fileinfo->getFilename()));
