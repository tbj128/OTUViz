  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="page-header">
        <h1 id="navbar"><i class="fa fa-database"></i> Add Samples</h1>
        <h3>Upload a dataset or add a single sample below.</h3>
      </div>
      ...
      <form style="display:none;" enctype="multipart/form-data" action="upload/upload_samples.php" method="POST">
